...
const MainAndroidStudio = () => {
  ...
  <div className="top-title" >
    <p style={{ marginTop: 60, marginBottom: 60 }}>
      Projects built with <span >Android Studio</span>
    </p>
  ...
  <div className="parents_card parents_card2">
    ...
    <div className="card">
      ...
      <div className="div_span">
        ...
        <span className="sppan">
          <a to="/AdminClientSide" className="Admin_Client_side">
            Admin-Client side
          </a>
        </span>
      </div>
    ...
    <div className="card">
      ...
      <div className="div_span">
        ...
        <span className="sppan">
          <aLink to="/android" className="Android">
            Android
          </aLink>
        </span>
        <span className="sppan">
...
export default MainAndroidStudio;
